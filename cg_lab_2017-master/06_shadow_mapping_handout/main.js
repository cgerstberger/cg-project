...
function render(timeInMilliseconds) {
  ...
  let lookAtMatrix = mat4.lookAt(mat4.create(), [0 + camera.translation.x, 5 + camera.translation.y, -200 + camera.translation.z], [0, 0, 0], [0, 1, 0]);
  ...
  if (lastTime != 0) {
    ...
    if (speed != 0) {
      ...
      zPos -= Math.sin(degToRad(yaw)) * speed * elapsed;
    }
